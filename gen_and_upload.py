# -*- coding: utf-8 -*-
"""生成单篇文章封面图+清单，然后上传到头条草稿箱"""
import os, json, base64, re
from datetime import datetime

BASE = r"C:\Users\huixi\Documents\trae_projects\ttwz"
...
print(f"HTML: {html_file} (mtime: {os.path.getmtime(html_file)})")
...
manifest_path = os.path.join(work_dir, "single_manifest.json")
